namespace Remoting.Config
{
	...
	public class ConfigManager
	{
		...
		public static bool tcp_nodelay()
		{
			return getBool(Configs.TCP_NODELAY, Configs.TCP_NODELAY_DEFAULT);
		}

		public static bool tcp_so_reuseaddr()
		{
		...
		public static bool tcp_so_keepalive()
		{
		...
		public static bool netty_buffer_pooled()
		{
		...
		{
			return getInt(Configs.CONN_CREATE_TP_KEEPALIVE_TIME, Configs.CONN_CREATE_TP_KEEPALIVE_TIME_DEFAULT);
		}
        ...
        public static readonly byte serializer_Renamed = serializer();
		...
		{
			return bool.Parse(java.lang.System.getProperty(key, defaultValue));
		}

		public static int getInt(string key, string defaultValue)
		{
			return int.Parse(java.lang.System.getProperty(key, defaultValue));
		}

		public static byte getByte(string key, string defaultValue)
		{
			return byte.Parse(java.lang.System.getProperty(key, defaultValue));
		}

		public static long getLong(string key, string defaultValue)
		{
			return long.Parse(java.lang.System.getProperty(key, defaultValue));
		}
	}
}