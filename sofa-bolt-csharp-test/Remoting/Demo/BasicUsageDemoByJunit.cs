...
namespace com.alipay.remoting.demo
{
    /// <summary>
    /// basic usage demo
    ...
    public class BasicUsageDemoByJunit : IDisposable
    {
        private bool InstanceFieldsInitialized = false;

        public BasicUsageDemoByJunit()
        {
        ...
        {
            private readonly BasicUsageDemoByJunit outerInstance;

            private IList<string> rets;
            private CountdownEvent latch;

            public InvokeCallbackAnonymousInnerClass(BasicUsageDemoByJunit outerInstance, IList<string> rets, CountdownEvent latch)
            {
