...
namespace com.alipay.remoting.rpc
{
    ...
    public class BasicUsage_AsyncProcessor_Test: IDisposable
    {
		private bool InstanceFieldsInitialized = false;

		public BasicUsage_AsyncProcessor_Test()
		{
		...
		internal AsyncServerUserProcessor serverUserProcessor = new AsyncServerUserProcessor();
		internal AsyncClientUserProcessor clientUserProcessor = new AsyncClientUserProcessor();
...
//ORIGINAL LINE: final java.util.concurrent.CountdownEvent latch = new java.util.concurrent.CountdownEvent(1);
		...
		{
			private readonly BasicUsage_AsyncProcessor_Test outerInstance;

			private IList<string> rets;
			private CountdownEvent latch;

			public InvokeCallbackAnonymousInnerClass(BasicUsage_AsyncProcessor_Test outerInstance, IList<string> rets, CountdownEvent latch)
			{
