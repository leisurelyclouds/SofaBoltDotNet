...
namespace com.alipay.remoting.rpc.invokecontext
{
    ...
    public class BasicUsage_InvokeContext_resuable_Test : IDisposable
    {
        private bool InstanceFieldsInitialized = false;

        public BasicUsage_InvokeContext_resuable_Test()
        {
        ...
        {
            private readonly BasicUsage_InvokeContext_resuable_Test outerInstance;

            private IList<string> rets;
            private CountdownEvent latch;

            public InvokeCallbackAnonymousInnerClass(BasicUsage_InvokeContext_resuable_Test outerInstance, IList<string> rets, CountdownEvent latch)
            {
