...
namespace com.alipay.remoting.rpc
{
    ...
    public class BasicUsage_ProtocolV2_1_Test: IDisposable
    {
		private bool InstanceFieldsInitialized = false;

		public BasicUsage_ProtocolV2_1_Test()
		{
		...
		{
			addr = "127.0.0.1:" + port + "?_PROTOCOL=2&_VERSION=1";
		}
...
//ORIGINAL LINE: final java.util.concurrent.CountdownEvent latch = new java.util.concurrent.CountdownEvent(1);
		...
		{
			private readonly BasicUsage_ProtocolV2_1_Test outerInstance;

			internal Executor executor = Executors.newCachedThreadPool();
			internal IList<string> rets;
			internal CountdownEvent latch;

			internal InvokeCallBackImpl(BasicUsage_ProtocolV2_1_Test outerInstance, IList<string> rets, CountdownEvent latch)
			{
