...
namespace com.alipay.remoting.rpc.userprocessor.executorselector
{
    ...
    public class BasicUsage_ExecutorSelector_Test: IDisposable
    {
        ...
        public BasicUsage_ExecutorSelector_Test()
		{
		...
		internal SpecificServerUserProcessor serverUserProcessor = new SpecificServerUserProcessor();
		internal SpecificClientUserProcessor clientUserProcessor = new SpecificClientUserProcessor();
		...
		internal UserProcessor_ExecutorSelector selector0 = new DefaultExecutorSelector(DefaultExecutorSelector.EXECUTOR0);
		internal UserProcessor_ExecutorSelector selector1 = new DefaultExecutorSelector(DefaultExecutorSelector.EXECUTOR1);
...
//ORIGINAL LINE: @Before private void init()
		private void init()
		{
			...
			serverUserProcessor.ExecutorSelector = this.selector0;
			server.registerUserProcessor(serverUserProcessor);

			client = new RpcClient();
			client.addConnectionEventProcessor(ConnectionEventType.CONNECT, clientConnectProcessor);
			client.addConnectionEventProcessor(ConnectionEventType.CLOSE, clientDisConnectProcessor);
			clientUserProcessor.ExecutorSelector = this.selector1;
...
//ORIGINAL LINE: final java.util.concurrent.CountdownEvent latch = new java.util.concurrent.CountdownEvent(1);
		...
		{
			private readonly BasicUsage_ExecutorSelector_Test outerInstance;

			private IList<string> rets;
			private CountdownEvent latch;

			public InvokeCallbackAnonymousInnerClass(BasicUsage_ExecutorSelector_Test outerInstance, IList<string> rets, CountdownEvent latch)
			{
