...
namespace com.alipay.remoting.rpc.userprocessor.multiinterestprocessor
{
    ...
    /// </summary>
    public class SimpleServerMultiInterestUserProcessor : SyncMutiInterestUserProcessor
    {
        ...
        public SimpleServerMultiInterestUserProcessor(int delay) : this()
        {
            if (delay < 0)
            {
        ...
        public SimpleServerMultiInterestUserProcessor(int delay, int core, int max, int keepaliveSeconds, int workQueue) : this(delay)
        {
