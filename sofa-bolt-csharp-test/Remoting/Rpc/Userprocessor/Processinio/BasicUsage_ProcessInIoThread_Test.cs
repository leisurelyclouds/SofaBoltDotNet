...
namespace com.alipay.remoting.rpc.userprocessor.processinio
{
    ...
    public class BasicUsage_ProcessInIoThread_Test: IDisposable
    {
		private bool InstanceFieldsInitialized = false;

		public BasicUsage_ProcessInIoThread_Test()
		{
...
//ORIGINAL LINE: final java.util.concurrent.CountdownEvent latch = new java.util.concurrent.CountdownEvent(1);
		...
		{
			private readonly BasicUsage_ProcessInIoThread_Test outerInstance;

			private IList<string> rets;
			private CountdownEvent latch;

			public InvokeCallbackAnonymousInnerClass(BasicUsage_ProcessInIoThread_Test outerInstance, IList<string> rets, CountdownEvent latch)
			{
