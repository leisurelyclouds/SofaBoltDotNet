...
namespace com.alipay.remoting.rpc.watermark
{
    ...
    public class WaterMark_SystemProperty_ExceptionTest: IDisposable
    {
		private bool InstanceFieldsInitialized = false;

		public WaterMark_SystemProperty_ExceptionTest()
		{
...
//ORIGINAL LINE: final java.util.List<Nullable<bool>> overFlow = new java.util.ArrayList<Nullable<bool>>();
        ...
        {
			private readonly WaterMark_SystemProperty_ExceptionTest outerInstance;

			private RequestBody req;
			private IList<bool> overFlow;
			private int i;

			public ThreadAnonymousInnerClass(WaterMark_SystemProperty_ExceptionTest outerInstance, RequestBody req, IList<bool> overFlow, int i)
			{
...
//ORIGINAL LINE: final com.alipay.remoting.rpc.common.RequestBody req = new com.alipay.remoting.rpc.common.RequestBody(1, 1024);
		...
		private class ThreadAnonymousInnerClass2 : java.lang.Thread
        {
			...
			public ThreadAnonymousInnerClass2(WaterMark_SystemProperty_ExceptionTest outerInstance, string remoteAddr, IList<bool> overFlow, RequestBody req, int i)
			{
				this.outerInstance = outerInstance;
