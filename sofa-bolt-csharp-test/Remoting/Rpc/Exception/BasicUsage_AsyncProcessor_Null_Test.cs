...
namespace com.alipay.remoting.rpc.exception
{
    ...
    public class BasicUsage_AsyncProcessor_Null_Test : IDisposable
    {
        private bool InstanceFieldsInitialized = false;

		public BasicUsage_AsyncProcessor_Null_Test()
		{
		...
		internal AsyncServerUserProcessor serverUserProcessor = new AsyncServerUserProcessor(false, true);
		internal AsyncClientUserProcessor clientUserProcessor = new AsyncClientUserProcessor(false, true);
...
//ORIGINAL LINE: final java.util.concurrent.CountdownEvent latch = new java.util.concurrent.CountdownEvent(1);
		...
		{
			private readonly BasicUsage_AsyncProcessor_Null_Test outerInstance;

			private IList<object> rets;
			private CountdownEvent latch;

			public InvokeCallbackAnonymousInnerClass(BasicUsage_AsyncProcessor_Null_Test outerInstance, IList<object> rets, CountdownEvent latch)
			{
